...
import {
  User, Settings, Shield, SlidersHorizontal, Bell, History, LifeBuoy,
} from 'lucide-react';
import { UserProfile } from '../../../store/userProfileStore';

export type ProfileNavKey =
  | 'personal' | 'account' | 'security' | 'preferences' | 'notifications' | 'activity';

const NAV_ITEMS: { key: ProfileNavKey; label: string; icon: React.ComponentType<{ className?: string }> }[] = [
