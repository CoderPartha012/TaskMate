    ...
    <div className="flex flex-col sm:flex-row items-center justify-between gap-3 mt-4 text-xs text-white/40">
      <div className="flex items-center gap-3">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <select
            ...
            className="rounded-lg bg-noir-600 border border-white/[0.08] text-white/60 text-xs px-2 py-1 focus:outline-none focus:border-jade"
          >
      ...
      <div className="flex items-center gap-1">
        <button
          ...
          className="p-1.5 rounded-lg border border-white/[0.08] text-white/50 hover:text-white disabled:opacity-30 disabled:cursor-not-allowed transition-colors"
        >
