...
import { TaskCategoryOverview, TASK_TYPE_LABELS } from '../common/TaskTypeSelector';
...
export function TaskForm() {
  ...
  const handleDeleteDraftFromList = (draft: TaskDraft) => {
    ...
    useToastStore.getState().showToast({ message: 'Draft deleted' });
  };
