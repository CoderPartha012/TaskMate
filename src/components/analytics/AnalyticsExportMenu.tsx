...
export function AnalyticsExportMenu({ tasks }: AnalyticsExportMenuProps) {
  ...
  return (
    <div ref={ref} className="relative">
      ...
      {open && (
        <div className="absolute right-0 top-full mt-2 w-44 bg-noir-700 border border-white/[0.08] rounded-xl shadow-2xl z-50 overflow-hidden">
          <button
            type="button"
